...
import com.example.towerssystem.databinding.ActivityShowPurchasesBinding;
...
public class ShowPurchases extends AppCompatActivity implements DetailsClick {
    ActivityShowPurchasesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityShowPurchasesBinding.inflate(getLayoutInflater());
    ...
    private void getCategoriesOfId() {
        ...
        categoriesController.getAllCategoriesOfCategorieId(id, new ShowListenirs() {
            ...
            public void onSuccess(List<com.example.towerssystem.models.ShowCategorie> list) {
                ...
                binding.rvPurhases.setAdapter(adapter);
                binding.rvPurhases.setLayoutManager(new LinearLayoutManager(ShowPurchases.this));
                binding.rvPurhases.setHasFixedSize(true);
            }
    ...
    private void operationsSccren() {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ShowPurchases.this,R.color.black));
